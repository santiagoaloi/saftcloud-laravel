  ...
  <div>
    <v-app-bar app flat height="80">
      ...
      >
        ...
        >
          <img :src="require('@/assets/images/logo2.png')" height="40" />
      ...
      <router-link
        ...
        class="d-flex align-center text-decoration-none mr-2"
      >
        <v-btn height="36" class="mr-3" rounded color="primary">Sign up</v-btn>
      </router-link>
          ...
          <v-list rounded="xl" color="rgba(250, 250, 250, 1)" outlined>
            <v-list-item>
              ...
              <v-list-item-content>
                ...
                >
                <v-list-item-subtitle>{{ sessionEmail }}</v-list-item-subtitle>
              </v-list-item-content>
            </v-list-item>
          </v-list>
          <v-list rounded="xl" color="rgba(250, 250, 250, 1)" outlined>
