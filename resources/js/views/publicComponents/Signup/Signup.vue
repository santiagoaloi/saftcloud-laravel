     ...
     <v-sheet color="grey lighten-4" class="text-center" height="400px">
      ...
      <v-scroll-x-transition hide-on-leave>
       <div v-if="step === 4">
        <v-card-text>
         <p class="display-1 text--primary">
          Welcome on board {{ signupForm.name }}!
         </p>

         <div class="mt-5 mb-5 text-h5">
          let's double check the information your provided before we can move
          forward with the registration of your shiny new account "<b>{{
         ...
         <v-checkbox :ripple="false" class="mt-10" v-model="terms">
          <template v-slot:label>
           <div>
            I confirm that my information is genuine and that I represent the
            business I'm creating the account for, as well as reading and
            accepting
