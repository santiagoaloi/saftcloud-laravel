          ...
          <v-row align="center" justify="center">
            <v-col cols="12" lg="6">
              ...
              <div class="text-h6 text-lg-h5 mt-5">
                Start selling your products online with a dedicated shopping
                cart site for your business. Customize the layouts, themes,
                banners using straight forward drag and drop elements out of the
                box. Integrate third åarty payment vendores like stripe or
                paypal.
              </div>
            </v-col>
            <v-col cols="12" lg="6">
