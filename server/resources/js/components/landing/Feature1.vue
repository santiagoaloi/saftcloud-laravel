  ...
  >
    <v-container>
      <div class="d-flex justify-center py-10">
        <v-card color="white" data-aos="zoom-in" data-aos-mirror="true" data-aos-offset="400" width="100%">
          ...
          <v-row align="center" justify="center">
            <v-col cols="12" lg="6">
              ...
              <div class="text-h6 text-lg-h5 mt-5">
                Start selling your products online with a dedicated shopping cart site for your business. Customize the
                layouts, themes, banners using a straight forward drag-and-drop elements out of the box. Integrate third
                party payment vendors like stripe or paypal.
              </div>
            </v-col>
            <v-col cols="12" lg="6">
              <v-img contain src="storage/ecomerce.png" max-height="400"></v-img>
            </v-col>
          </v-row>
        </v-card>
      </div>
