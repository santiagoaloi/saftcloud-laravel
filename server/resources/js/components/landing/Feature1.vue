<template>
    <v-responsive class="mx-auto text-left mb-10 test mt-n1">
        <v-container>
                        ...
                        <v-col lg="7">
                            <v-container fluid>
                                ...
                                <div class="text-h6 text-lg-h5 black--text">
                                    We will hire hundreds of people who read
                                    these words. We cannot possibly succeed in
                                    our goals without doing so. We would be
                                </div>
                                <v-btn
                                    x-large
                ...
                >
                    <v-row align="center" justify="center">
                        <v-col cols="12" lg="6">
                            ...
                            >
                                Create your own ecomerce site and start selling
                                in no time
                            </div>
                            <h2 class="text-h3">
                                ...
                                >
                                    <v-row align="center" justify="start">
                                        ...
                                        <v-col lg="7">
                                            <v-container fluid>
                                                <h2
                                                    class="text-h3 mb-2 black--text mb-5"
                                                >
                                                    Security
                                                </h2>
                                                <div
                                                    class="text-h6 text-lg-h5 black--text"
                                                >
                                                    We will hire hundreds of
                                                    people who read these words.
