  ...
  <v-container class="pt-4 pt-md-8 pb-10">
   ...
   <v-row class="mt-10" dense>
    ...
    <v-col v-for="(plan, i) in plans" :key="i" cols="12" md="6" lg="4">
     <v-card class="text-body-1" outlined light elevation="2" :class="[plan.highlight && 'pricing-highlight']">
      <v-sheet class="pa-4 text-center">
       ...
       <div class="d-flex justify-center ml-n3">
        ...
        <div class="text-h1 font-weight-black text-number">{{ plan.price }}</div>
       </div>
      ...
      <v-sheet class="pa-4" color="grey lighten-5">
       ...
       <v-btn x-large block outlined :dark="plan.highlight" :class="[plan.highlight && 'primary']">Subscribe</v-btn>
      </v-sheet>
     </v-card>
    </v-col>
   </v-row>
