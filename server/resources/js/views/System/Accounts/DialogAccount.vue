<template>
 <baseDialog
  ...
  icon="mdi-plus"
 >
  <ValidationObserver ref="createAccountForm" slim>
   <v-row>
    <v-col cols="12" lg="6">
     <baseFieldLabel required label="Name" />
     <validation-provider v-slot="{ errors, reset }" name="Name" rules="required">
      <v-text-field
       spellcheck="false"
    ...
    <v-col cols="12" lg="6">
     ...
     <validation-provider v-slot="{ errors, reset }" name="Email" rules="required">
      <v-text-field
       spellcheck="false"
