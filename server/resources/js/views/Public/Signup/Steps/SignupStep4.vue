<template>
 <div>
  ...
  <v-checkbox :color="isDark ? 'indigo lighten-2' : 'indigo'" :dark="isDark" :ripple="false" class="mt-10" v-model="terms">
   <template v-slot:label>
    <div>
     I confirm that my information is genuine and that I represent the business I'm creating the account for, as well as reading and accepting
