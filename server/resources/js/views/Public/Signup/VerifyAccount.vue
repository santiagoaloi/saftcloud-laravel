          ...
          <v-sheet color="white" class="text-center" height="400px">
                ...
                <v-card-text>
                  ...
                  <ValidationObserver ref="step0" slim>
                    <v-row justify="center">
                      <v-col sm="6">
                        <span>Account</span>
                        <v-text-field v-model="account" disabled solo hide-details />
                      </v-col>
                      <v-col sm="6">
            ...
            <v-scroll-x-transition hide-on-leave>
              <div v-if="step === 1">
                  ...
                  <ValidationObserver ref="step0" slim>
                    <v-row justify="center">
                      <v-col sm="12">
                        ...
                        <v-text-field v-model="accountEmail" disabled solo hide-details />
                      </v-col>
                      <v-col sm="6">
                        <span>Password</span>
                        <validation-provider
                ...
                <v-btn class="mx-1" large color="primary" @click="nextStep(1)"> Login </v-btn>
              </div>
            </v-scroll-x-transition>
          </v-sheet>
        </v-col>
