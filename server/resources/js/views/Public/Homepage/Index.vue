        ...
        <div class="d-flex flex-column justify-center">
          ...
          <v-card flat color="transparent" width="600">
            ...
            <h3 class="text-shadow white--text mt-10" style="font-weight: 100">
              Saftcloud ™ is a cloud-based retail software platform that enables retailers speed up
              sales, manage inventories, reward customer loyalty, and garner insights into their
              businesses in real-time. The platform makes it easy to add new outlets and registers
              as your business grows. Designed for multi-outlet retailers, Saftcloud ™ ensures that
