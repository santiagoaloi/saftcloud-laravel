            ...
            <v-scroll-x-transition hide-on-leave>
              <div v-if="step === 0">
                ...
                <v-btn
                  ...
                  >Send verification code again</v-btn
                >
                <v-btn class="mx-1" @click="nextStep(1)" large color="primary"
            ...
            <v-scroll-x-transition hide-on-leave>
              <div v-if="step === 1">
                <v-card-text>
                  ...
                  <div class="text-h6 text-lg-h5 mt-5 mb-5">
                    You're almost there! - Once you create a password for your
                    account, you will be re-directed to your brand new
