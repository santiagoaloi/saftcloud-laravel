...
export default {
  ...
  mounted() {
    ...
    this.$watch(
      () => {
        return this.$refs.refDropDownProducts.isMenuActive;
      },
      (val) => {
  ...
  methods: {
      ...
      if (result.length === 0) {
        ...
        for (let i = 0, length = CartRows.length; i < length; i++) {
          if (CartRows[i].product_id === this.itemSelected.product_id) {
            ...
            let post = {
              invoice_number: this.temporalInvoiceNumber,
            ...
            axios
              .post(this.controller + "/insertUpdateProduct/", post)
              .then((response) => {
                if (response.data.status === "Success") {
                  if (this.$vuetify.breakpoint.smAndDown) {
                    this.dropDownProductsKey++;
    ...
    push_new_product() {
      ...
      let post = {
        ...
        transaction_id: this.itemSelected.transaction_id,
    ...
    modifyAmount(item) {
      ...
      axios.post(this.controller + "/insertUpdateProduct/", post);
    },
    ...
    insertDesc() {
      ...
      this.salesOrderRows.unshift({ ...postFrontend });
      axios
        .post(this.controller + "/insertDiscount/", post)
        .then((response) => {
          if (response.data.status === "Success") {
    ...
    deleteDesc(item) {
      item.loading = "1";
      let post = {
        ids: item[this.primaryIndex],
        invoice_number: item.invoice_number,
        discount_id: item.discount_id,
      };
      axios.post(this.controller + "/deleteDesc/", post).then((response) => {
    ...
    deleteItem(item) {
      ...
      axios.post(this.controller + "/deleteItem/", post).then((response) => {
        this.refresh_sales_order_temp();
        item.loading = "0";
      });
    },
    ...
    getPricesRules() {
      axios.get(`${this.controller}/getPricesRules/`).then((response) => {
        if (response.data.status === "Success") {
    ...
    getPaymentOptions() {
      axios.get(this.controller + "/getPaymentOptions/").then((response) => {
        if (response.data.status === "Success") {
    ...
    getDropdownCcardInteres() {
      axios
        .get(this.controller + "/getDropdownCcardInteres/")
        .then((response) => {
          if (response.data.status === "Success") {
    ...
    getDropdownProducts() {
      axios.get(this.controller + "/getDropdownProducts/").then((response) => {
        if (response.data.status === "Success") {
    ...
    getDropdownTipoComprobante() {
      axios
        .get(this.controller + "/getDropdownTipoComprobante/")
        .then((response) => {
          if (response.data.status === "Success") {
    ...
    getDropdownIvaCondition() {
      axios
        .get(this.controller + "/getDropdownIvaCondition/")
        .then((response) => {
          if (response.data.status === "Success") {
    ...
    getDropdownTipoDocumento() {
      axios
        .get(this.controller + "/getDropdownTipoDocumento/")
        .then((response) => {
          if (response.data.status === "Success") {
    ...
    getDropdownStates() {
      axios.get(this.controller + "/getDropdownStates/").then((response) => {
        if (response.data.status === "Success") {
    ...
    getDropdownCities() {
      axios.get(this.controller + "/getDropdownCities/").then((response) => {
        if (response.data.status == "Success") {
    ...
    getSellers() {
      axios.get(this.controller + "/getSellers/").then((response) => {
        if (response.data.status == "Success") {
    ...
    getVisitDays() {
      axios.get(this.controller + "/getVisitDays/").then((response) => {
        if (response.data.status == "Success") {
    ...
    getAfipNextNroComp() {
      ...
      axios
        .post(this.controller + "/getAfipNextNroComp/", post)
        .then((response) => {
          if (response.data.status == "Success") {
    ...
    salesProcess() {
      ...
      axios.post(this.controller + "/salesProcess/", post).then((response) => {
        if (response.data.status === "Success") {
          this.generated_sales_transaction_id = response.data.transaction_id;
          this.SalesOrder();
        } else {
          this.$swal({
    ...
    SalesOrder() {
      let post = {
        ...
        sales_transaction_id: this.generated_sales_transaction_id,
      };
      axios.post(this.controller + "/salesOrder/", post).then((response) => {
        if (response.data.status === "Success") {
    ...
    inputCashReg() {
      ...
      axios.post(this.controller + "/inputCashReg/", post).then((response) => {
        if (response.data.status === "Success") {
          this.clearShoppingCart();
          sessionStorage.removeItem("budgetNumber");
          sessionStorage.setItem(
            "sales_transaction_id",
            this.generated_sales_transaction_id
          );
          sessionStorage.setItem("type", "shoppingCart");
          // sessionStorage.setItem("type", "services");
    ...
    updateCcte() {
      this.$validator.validateAll().then((result) => {
        if (result) {
          ...
          axios
            .post(this.controller + "/updateCcte/", post)
            .then((response) => {});
        }
      });
    },
    ...
    columnTable() {
      axios
        .get(this.controller + "/columnTable/" + "products")
        .then((response) => {
    ...
    deleteItemBulk(length) {
      this.$swal({
        ...
        if (result.value) {
          ...
          axios
            .post(this.controller + "/deleteItemBulk/", post)
            .then((response) => {
              if (response.data.status === "Success") {
