    ...
    children: [
      {
        ...
        component: () =>
          import(
            "@/views/systemComponents/ComponentsManagement/Info/Index.vue"
          ),
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import(
            "@/views/systemComponents/ComponentsManagement/Form/Index.vue"
          ),
      },
      {
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { layout: "secure_layout" },
        component: () =>
          import("@/views/systemComponents/AppConfig/Emails.vue"),
      },
    ],
  },
];
