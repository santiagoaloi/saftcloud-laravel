...
<script>
  ...
  Vue.component('AccountsDrilldown', () =>
    import(
      /* webpackChunkName: 'accounts-navigation-drilldown' */ '@/components/Navigation/AccountsDrilldown'
    ),
  );
  Vue.component('AccountsDrilldownBar', () =>
    import(
      /* webpackChunkName: 'accounts-navigation-drilldown-bar' */ '@/components/Navigation/AccountsDrilldownBar'
    ),
  );
