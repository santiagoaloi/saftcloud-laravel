...
const publicDir = "C:/xampp/htdocs/laravel-vue-test/public";
...
Mix.listen("configReady", config => {
    ...
    scssRule.oneOf.forEach(ruleset => {
        const scssOptions = ruleset.use.find(l => l.loader === "sass-loader")
            .options;

        scssOptions.additionalData =
            "@import './resources/sass/vuetify/variables';";
    });
    ...
    sassRule.oneOf.forEach(ruleset => {
        const sassOptions = ruleset.use.find(l => l.loader === "sass-loader")
            .options;
...
mix.js("resources/js/app.js", "public/dist/js")
    ...
    .webpackConfig({
        ...
        output: {
            ...
            path: "C:/xampp/htdocs/laravel-vue-test/public/build",
